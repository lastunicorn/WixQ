...
namespace DustInTheWind.DeferredCustomActionWithParams.CustomActions
{
    public class LogSomethingCustomAction
    {
        ...
        public static ActionResult Execute(Session session)
        {
            try
            {
                ...
                session.Log("This is a demo, to show how to create and execute a deferred custom action that receives parameters.");
